  ...
  const services = [
    {
      ...
      text: "Connect your job boards once",
    },
    {
      icon: "/images/icons/icon-blockchain.svg",
      text: "Let CrypGo auto‑apply with guardrails",
    },
    {
      icon: "/images/icons/icon-Services.svg",
      text: "Track interviews and responses in one view",
    },
  ];
        ...
        <div ref={ref} className="grid grid-cols-12 items-center">
          ...
          >
            <p className="sm:text-28 text-18 text-white">
              Job search with <span className="text-primary">autopilot</span>
            </p>
            <h2 className="sm:text-40 text-30 text-white lg:w-full md:w-70% font-medium">
              Ship more tailored applications with less effort.
            </h2>
          ...
          <motion.div {...TopAnimation} className="lg:col-span-5 col-span-12">
            <div className="2xl:-mr-40 mt-9 flex justify-center">
              <Image
                src={`${getImagePrefix()}images/work/work_with_us.png`}
                alt="image"
                width={600}
                height={425}
                className="lg:w-full"
