      ...
      <div id="version" className="md:scroll-m-[180px] scroll-m-28">
        ...
        <div className="mt-5">
          <p className="text-base font-medium text-muted text-opacity-60">
            CrypGo is an auto job apply platform built with Next.js and
            Tailwind CSS. This starter keeps the UI focused on job search
            automations, dashboards, and profiles.
          </p>
          <p className="text-base font-medium text-muted text-opacity-60">
            You are expected to bring your own data layer (APIs, database,
            auth). All campaign, job, and profile screens are currently
            front‑end only so you can wire them to any backend you prefer.
          </p>
          <p className="text-base font-medium text-muted text-opacity-60">
            To customise it deeply, you should know Next.js, React, Tailwind,
            and JSX/TSX. From there you can plug in real job feeds, tracking,
            and automation engines behind the existing components.
          </p>
        </div>
      </div>
